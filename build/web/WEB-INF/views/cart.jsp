                                ...
                                <tr class="cart-row" id="row_<%= item.getCartItemID() %>">
                                    ...
                                    <td class="cart-product">
                                        <div class="cart-product-content">
                                            <img src="<%= product.getImageURL() %>" alt="lỗi ảnh" class="product-img">
                                            <br>
                                            ...
                                            <div class="product-info">
                                                ...
                                                <span class="product-variant" style="display: block; font-size: 14px; text-align: left; margin-top: -20px;">
                                                    <%= item.getColor().getColorName() %> / <%= item.getStorage().getCapacity() %>GB
                                                </span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="cart-price">₫<%= String.format("%,.0f", item.getPrice()) %></td>
