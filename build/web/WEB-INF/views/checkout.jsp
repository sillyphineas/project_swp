...
<%@page import="java.util.List,entities.Cart,entities.CartItem,entities.Product,jakarta.servlet.http.HttpSession,entities.User,entities.ProductVariant,entities.Address" %>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
