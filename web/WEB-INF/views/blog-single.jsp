...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="blog-post-area">
                        <h2 class="title text-center">Post View</h2>
                        <%
                        ...
                        <div class="single-blog-post">
                            ...
                            <div class="post-meta">
                                ...
                                <span>
                                    <a href="MarketingPostController?service=updateBlog&id=<%= blog.getId() %>" 
                                       class="btn" 
                            ...
                            <a href="">
                                <img src="<%= blog.getImageURL() %>" alt="Blog Image" style="max-width: 30%; height: auto; margin: 0 auto; display: block;" />
                            </a>
                            <p><%= blog.getContent() %></p>
        ...
        function showNotification(message) {
            ...
            }, 1000); // Adjust time (in milliseconds) to your preference
        }
    ...
    <div id="notification" class="alert alert-info" style="display: none;">
        <p id="notification-message">Blog updated successfully!</p>
    </div>
