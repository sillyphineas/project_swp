                ...
                <div class="set-password-container">
                    ...
                    <form action="ResetController" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="newPassword" name="newPassword" maxlength="18" placeholder="Enter new password" required>
                        </div>

                        <div class="form-group">
                            <label for="confirmPassword">Confirm Password</label>
                            <input type="password" id="confirmPassword" name="confirmPassword" maxlength="18" placeholder="Confirm new password" required>
                        </div>
