...
<!--                                                <li><a href="#"><i class="fa fa-user"></i> Account</a></li>
                    ...
                    <form action="${pageContext.request.contextPath}/SliderController" method="post">
                        ...
                        <input type="text" name="title" value="${slider.title}" required><br><br>
                        <label for="content">Content:</label>
                        <textarea name="content" required>${slider.content}</textarea><br><br>
                        <label for="imageURL">Image URL:</label>
                        <input type="text" name="imageURL" value="${slider.imageURL}" required><br><br>
                        <label for="backlinks">Backlinks:</label>
                        <input type="text" name="backlinks" value="${slider.backlinks}" required><br><br>
